...
++  handle-request
  ...
  ::  ── programmable pages (docs/platform.md step 2) ──
      [%'GET' %'prism.js']
    ;<  pv=view:nexus  bind:m  (peek:io [%& %& app-base %'prism.js'] ~)
