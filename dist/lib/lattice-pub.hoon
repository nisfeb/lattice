...
++  key-to-rail
  ...
  ?~  rest  ~
  ::  dir = all-but-last, leaf = last. scag/snag/lent only (the grubbery DESK
  ::  kernel that /+ builds against lacks +rear/+snip; gub has them, the desk
  ::  doesn't — so stick to the vocabulary lattice-know proves is available).
  =/  n=@ud  (dec (lent rest))
